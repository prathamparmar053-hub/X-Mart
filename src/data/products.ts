...
export const groceryProducts: Product[] = [
  { 
    ...
    description: "Fresh seasonal vegetables from local certified organic farms.", 
    price: "$45.00", 
  ...
  { 
    ...
    description: "Single-origin Arabica beans roasted to perfection.", 
    price: "$28.50", 
    image: "https://images.unsplash.com/photo-1559056199-641a0ac8b55e?auto=format&fit=crop&q=80&w=800" 
  },
  { 
    id: 103, 
    name: "Artisanal Spice Collection", 
    description: "Hand-picked spices from around the world for gourmet cooking.", 
    price: "$35.00", 
    image: "https://images.unsplash.com/photo-1506368249639-73a05d6f6488?auto=format&fit=crop&q=80&w=800" 
  },
  { 
    id: 104, 
    name: "Gourmet Pantry Essentials", 
    description: "High-quality oils, vinegars, and grains for fine dining at home.", 
    price: "$52.00", 
...
export const clothesProducts: Product[] = [
  { 
    ...
    description: "Premium wool blend suit for a sharp professional look.", 
    price: "$899.00", 
  ...
  { 
    ...
    description: "Elegant 100% silk blouse for corporate environments.", 
    price: "$145.00", 
    image: "https://images.unsplash.com/photo-1548126032-079a0fb0099d?auto=format&fit=crop&q=80&w=800" 
  },
  { 
    id: 203, 
    name: "Modern Business Casual Set", 
    description: "Versatile pieces for a contemporary workplace aesthetic.", 
    price: "$220.00", 
  ...
  { 
    ...
    description: "Handcrafted Italian leather bag for the modern executive.", 
    price: "$350.00", 
...
export const sportsProducts: Product[] = [
  { 
    ...
    description: "Carbon fiber frame for ultimate power and precision.", 
    price: "$210.00", 
  ...
  { 
    ...
    description: "Smart treadmill with interactive training programs.", 
    price: "$1,450.00", 
    image: "https://images.unsplash.com/photo-1538805060514-97d9cc17730c?auto=format&fit=crop&q=80&w=800" 
  },
  { 
    id: 303, 
    name: "Ergonomic Yoga Kit", 
    description: "Non-slip mat and eco-friendly support blocks.", 
    price: "$85.00", 
  ...
  { 
    ...
    description: "Advanced health monitoring with multi-sport tracking.", 
    price: "$199.00", 
...
export const electronicsProducts: Product[] = [
  { 
    ...
    description: "Ultra-fast processor and stunning 16-inch display.", 
    price: "$2,199.00", 
  ...
  { 
    ...
    description: "Immersive audio experience with industry-leading ANC.", 
    price: "$349.00", 
  ...
  { 
    ...
    description: "Perfect for productivity and creative professional work.", 
    price: "$650.00", 
  ...
  { 
    ...
    description: "Integrated hub for controlling your entire workspace.", 
    price: "$299.00", 
